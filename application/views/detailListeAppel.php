                            ...
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <?php foreach ($stats as $row){?>
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "><?php echo $row->getAgent()->getNom() ?></td>
                                        <td class=" "><?php echo $row->getQuantiteTotale() ?> appel(s)</td>
                                        <td class=" ">
                                            <?php if($row->getQuantiteTotale()!=0){ ?>
                                                <ul class="list-inline user_data">
                                                    <li>
                                                        <p><?php echo $row->getPasinteresse() ?> </strong> Appel(s) pas intéressé</p>
                                                    ...
                                                    <li>
                                                        <p><?php echo $row->getRendezvous() ?> </strong> Appel(s) demandant un rendez-vous</p>
                                                        <div class="progress progress_md">
                                                    ...
                                                    <li>
                                                        <p><?php echo $row->getRappeler() ?> </strong> Appel(s) demandant un rappel</p>
                                                        <div class="progress progress_md">
